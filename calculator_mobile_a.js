...
function m_str_div_shrink(y,x){          
   ...
   var ans_1="";
    ...
    if(yy == 0 && xx != 0){ var  ans_1=0 ; return  ans_1;}  
    if(xx == 0){ var  ans_1= error  ;  return  ans_1;}      
    if(yy == xx){ var  ans_1=1 ; return  ans_1;}           

  var yy_lg=yy.length;
  var xx_lg=xx.length;

         yy_lst = yy.substr(yy_lg-1,1);  
         xx_lst = xx.substr(xx_lg-1,1);  
   
      if((yy_lst =="π" &&  xx_lst =="π")||(yy_lst =="°" &&  xx_lst =="°")) {
             var  yy = yy.substr(0,yy_lg-1);   
             var  xx = xx.substr(0,xx_lg-1);   
               if( yy==""){ var yy=1 ;}
               if( xx==""){ var xx=1 ;}
                                                                              }
      ...
      if(yy_lst =="π" &&  xx_lst =="°") {         
              ...
              if(yy_lg==1){
                 var  yy = yy.substr(0,yy_lg-1)+"180";      
                           }
              else{ var  yy = yy.substr(0,yy_lg-1)+"*180";}

              if(xx_lg==1){
                 var  xx = xx.substr(0,xx_lg-1)+"1";   
                           }
              else{var  xx = xx.substr(0,xx_lg-1);}   
                                       }
       ...
       if(yy_lst =="°" &&  xx_lst =="π") {         
              ...
              if(yy_lg==1){
                 var  yy = yy.substr(0,yy_lg-1)+"1";     
                           }
              else{ var  yy = yy.substr(0,yy_lg-1);}

             if(xx_lg==1){
                var  xx = xx.substr(0,xx_lg-1)+"180";   
                           }
              else{var  xx = xx.substr(0,xx_lg-1)+"*180";}   
                                       }

  
          if(yy_lst =="°" ) {                              

                 var  yy = yy.substr(0,yy_lg-1)+"π";   
                 var  xx = xx+"*180";                    
                              }
          if(xx_lst =="°" ) {                              

                 var  yy = yy+"*180";                   
                 var  xx = xx.substr(0,xx_lg-1)+"π";   
                              }

           var ans_1 = yy+"/"+xx;
    

             var nub_pi = m_str_spc_count(ans_1,"π");    

               if(nub_pi ==0){                      

                 var data_ans = eval( ans_1 );  

                 var data_ans_lg = data_ans.toString().length; 
                  
                   if( data_ans_lg <= 12){ var  ans_1 = data_ans ;}  
...
function s_nub_array(nub_1){           
   ...
   case "5_1":                                                  
    ...
    case "5_5":
     ...
     case "5_6":
       array_a=["1_2","1_5","1_6","2_6","3_0","4_6","5_1","5_2","5_5"];
      break; 
   ...
   function s_check_end(str){                             
       ...
       var array_a=[];    
          ...
          if(atanh_1==1 ||atanh_2==1 || atanh_3==1 || atanh_5==1){                 
                array_a=["2_0","2_3","2_4","2_5","3_3","3_4","3_5","4_3","4_4","4_5","5_4"]; }
...
function m_ext_in_funct(x){   
   var xx_st = x;
     ...
     xx_st = m_hat_bf_aft_many(xx_st ,'/','DDD');            
       
     xx_st = xx_st.replace(/DDD/g ,'m_mtx_real_div');           
               ...
               if( data_chk_1 <= 0.6 ){  xx_st=m_mtx_real_mul(xx_st,2); var nub_ln2 = m_mtx_int_sub(nub_ln2,1);}      
                  ...
                  if( data_chk_5 >= 0.95  && data_chk_5 <= 0.975 ){ 
                   ...
                   if( data_chk_5 >= 1.025  && data_chk_5 < 1.05 ){ 
                        xx_st=m_mtx_real_div(xx_st,1.05); var nub_ln3 = m_mtx_int_add(nub_ln3 , 1) ;  
                                                         var nub_ln5 = m_mtx_int_add(nub_ln5 , 1) ;  
                                                         var nub_ln7 = m_mtx_int_add(nub_ln7 , 1) ;  
                                                         var nub_ln10 = m_mtx_int_sub(nub_ln10 ,2); 
                                                                                     }     
